...
setwd("/Users/mac/Google Drive/A-UK-Research/IO-Wealth-All-Countries/SCF-IOp") #Set Working Directory
setwd("/Users/Juan/Google Drive/A-UK-Research/IO-Wealth-All-Countries/SCF-IOp/") #Set Working Directory for the LAPTOP
...
dataush <- dataush[dataush$age >= 35,]
...
q0 <- wtd.quantile (dataush$eqinh [dataush$eqinh > 0], q = 0, weight=dataush$weight[dataush$eqinh > 0], na.rm = T)
q1 <- wtd.quantile (dataush$eqinh [dataush$eqinh > 0], q = 0.25, weight=dataush$weight[dataush$eqinh > 0], na.rm = T)
q2 <- wtd.quantile (dataush$eqinh [dataush$eqinh > 0], q = 0.5, weight=dataush$weight[dataush$eqinh > 0], na.rm = T)
q3 <- wtd.quantile (dataush$eqinh [dataush$eqinh > 0], q = 0.75, weight=dataush$weight[dataush$eqinh > 0], na.rm = T)
...
saveRDS(dataush, file = "SCF-2016-all-after-1d-ad-eq-Oct19.rds")
