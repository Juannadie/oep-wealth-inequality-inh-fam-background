...
setwd("/Users/Juan/Google Drive/A-UK-Research/IO-Wealth-All-Countries/SCF-IOp/code") #Set Working Directory

shapleyimps <- read.csv(file = "results/us/bis1/us-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/us/bis1/us-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/us/bis1/us-results-interactive-full-imps.csv", row.names = NULL)
...
us_res_2 <- rbind (marginal_ses_res, marginal_inh_res, shapley_ses_res, shapley_inh_res, interactive_res)

colnames(us_res_2) <- c("estimate", "se", "low_ci", "high_ci")

write.csv (us_res_2, file = "results/us/bis1/us_res_2.csv")
