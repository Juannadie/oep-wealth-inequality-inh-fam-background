...
temp = list.files(pattern="SCF-2016-all-after-1e-bis1-*") #creates a list with all the personal files in the eu-silc directory directory
...
write.csv(results4typesbsUSfull, file = "results/us/bis1/us-results4types-full-imp1.csv")
write.table(results4typesbsUSfull, file = "results/us/bis1/us-results4types-full-imps.csv", append = T, sep = ",", row.names = T)

results6typesbsUSfull <- rbind(indextheil6t, indextheil6tIE, indexshare6t)

write.csv(results6typesbsUSfull, file = "results/us/bis1/us-results6types-full-imp1.csv")
write.table(results6typesbsUSfull, file = "results/us/bis1/us-results6types-full-imps.csv", append = T, sep = ",", row.names = T)



results24typesbsUSfull <- rbind(indextheil24t, indextheil24tIE, indexshare24t)

write.csv(results24typesbsUSfull, file = "results/us/bis1/us-results24types-full-imp1.csv")
write.table(results24typesbsUSfull, file = "results/us/bis1/us-results24types-full-imps.csv", append = T, sep = ",", row.names = T)


resultsmarginalUS <- rbind(indexmarginal_bk, indexmarginal_inh )

write.csv(resultsmarginalUS, file = "results/us/bis1/us-results-marginal-full-imp1.csv")
write.table(resultsmarginalUS, file = "results/us/bis1/us-results-marginal-full-imps.csv", append = T, sep = ",", row.names = T)


resultsinteractiveUS <- indexinteractive_bk_inh

write.csv(resultsinteractiveUS, file = "results/us/bis1/us-results-interactive-full-imp1.csv")
write.table(resultsinteractiveUS, file = "results/us/bis1/us-results-interactive-full-imps.csv", append = T, sep = ",", row.names = T)


resultsshapleyUS <- rbind(indexshapley_bk, indexshapley_inh )

write.csv(resultsshapleyUS, file = "results/us/bis1/us-results-shapley-full-imp1.csv")
write.table(resultsshapleyUS, file = "results/us/bis1/us-results-shapley-full-imps.csv", append = T, sep = ",", row.names = T)
