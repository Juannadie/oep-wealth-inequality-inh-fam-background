...
shapleyimps <- read.csv(file = "results/us/us-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/us/us-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/us/us-results-interactive-full-imps.csv", row.names = NULL)
...
write.csv (us_res_2, file = "results/us/us_res_2.csv")
