...
sesimps <- read.csv(file = "results/us/us-results4types-full-imps.csv", row.names = NULL)
...
inhimps <- read.csv(file = "results/us/us-results6types-full-imps.csv", row.names = NULL)
...
jointimps <- read.csv(file = "results/us/us-results24types-full-imps.csv", row.names = NULL)
...
write.csv (us_res, file = "results/us/us_res.csv")