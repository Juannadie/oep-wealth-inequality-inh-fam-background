...
dataukh <- dataukh[dataukh$age>=35,]
...
#We filter excluding the lowest weighted wealth decile

q10wealth <- wtd.quantile(dataukh$wealth, q=0.1, weight = dataukh$weight)

dataukh <- dataukh[dataukh$wealth > q10wealth,]
...
saveRDS(dataukh, file = "data_rds/datauk-new-final-no-cpt-new-data8a-bis2.rds")
