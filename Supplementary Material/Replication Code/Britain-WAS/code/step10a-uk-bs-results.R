...
sesimps <- read.csv(file = "results/uk/uk-results4types-full-imps.csv", row.names = NULL)
...
inhimps <- read.csv(file = "results/uk/uk-results6types-full-imps.csv", row.names = NULL)
...
jointimps <- read.csv(file = "results/uk/uk-results24types-full-imps.csv", row.names = NULL)
...
write.csv (uk_res, file = "results/uk/uk_res.csv")
