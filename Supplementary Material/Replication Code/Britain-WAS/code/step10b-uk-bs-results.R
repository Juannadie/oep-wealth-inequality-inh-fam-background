...
shapleyimps <- read.csv(file = "results/uk/uk-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/uk/uk-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/uk/uk-results-interactive-full-imps.csv", row.names = NULL)
...
write.csv (uk_res_2, file = "results/uk/uk_res_2.csv")
