...
shapleyimps <- read.csv(file = "results/uk_bis1/uk-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/uk_bis1/uk-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/uk_bis1/uk-results-interactive-full-imps.csv", row.names = NULL)
...
write.csv (uk_res_2, file = "results/uk_bis1/uk_res_2.csv")
