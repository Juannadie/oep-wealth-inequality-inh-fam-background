...
setwd("/Users/Juan/Google Drive/A-UK-Research/IO-Wealth-All-Countries/WAS-IOp/code/imp5") #Set Working Directory for the LAPTOP
...
summary(imp$imp$IEValW1$`5`)
attributes(imp$imp$IEValW1)

c.broad <- complete(imp, "broad")

  c.broad$inputlife1basic <- (c.broad$IEValW1.5)
...
lifeinput1basic <- subset(c.broad, select = c(CaseW3.5, personW3.5, inputlife1basic, flaginputlife1basic))


#AND WE MERGED THE IMPUTED VARIABLE AND THE FLAG TO THE MAIN DATASET

alldatawascomplet <- merge (alldatawas, lifeinput1basic, by.x = c("CaseW3", "personW3"), by.y = c("CaseW3.5", "personW3.5"), all.x = T)
...
summary(imp$imp$IEVal2W1$`5`)
attributes(imp$imp$IEVal2W1)

c.broad <- complete(imp, "broad")

c.broad$inputlife2basic <- (c.broad$IEVal2W1.5)
...
lifeinput2basic <- subset(c.broad, select = c(CaseW3.5, personW3.5, inputlife2basic, flaginputlife2basic))


#AND WE MERGED THE IMPUTED VARIABLE AND THE FLAG TO THE MAIN DATASET

alldatawascomplet <- merge (alldatawascomplet, lifeinput2basic, by.x = c("CaseW3", "personW3"), by.y = c("CaseW3.5", "personW3.5"), all.x = T)
...
c.broad$inputrecent1basic <- (c.broad$IValW1.5)
...
recentinput1basic <- subset(c.broad, select = c(CaseW3.5, personW3.5, inputrecent1basic, flaginputrecent1basic))

#AND WE MERGED THE IMPUTED VARIABLE AND THE FLAG TO THE MAIN DATASET

alldatawascomplet <- merge (alldatawascomplet, recentinput1basic, by.x = c("CaseW3", "personW3"), by.y = c("CaseW3.5", "personW3.5"), all.x = T)
...
summary(imp$imp$IVal2W1$`5`)
attributes(imp$imp$IVal2W1)

c.broad <- complete(imp, "broad")

c.broad$inputrecent2basic <- (c.broad$IVal2W1.5)
...
recentinput2basic <- subset(c.broad, select = c(CaseW3.5, personW3.5, inputrecent2basic, flaginputrecent2basic))


#AND WE MERGED THE IMPUTED VARIABLE AND THE FLAG TO THE MAIN DATASET

alldatawascomplet <- merge (alldatawascomplet, recentinput2basic, by.x = c("CaseW3", "personW3"), by.y = c("CaseW3.5", "personW3.5"), all.x = T)
