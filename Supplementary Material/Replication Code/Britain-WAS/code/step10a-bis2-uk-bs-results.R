...
sesimps <- read.csv(file = "results/uk_bis2/uk-results4types-full-imps.csv", row.names = NULL)
...
inhimps <- read.csv(file = "results/uk_bis2/uk-results6types-full-imps.csv", row.names = NULL)
...
jointimps <- read.csv(file = "results/uk_bis2/uk-results24types-full-imps.csv", row.names = NULL)
...
write.csv (uk_res, file = "results/uk_bis2/uk_res.csv")
