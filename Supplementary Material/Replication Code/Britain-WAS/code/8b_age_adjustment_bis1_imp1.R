...
ggsave(file="graphs/Wealth-Age-Profile-by-Gender-UK-log-bis1-imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
ggsave(file="graphs/Wealth-Age-Profile-by-Gender-Mean-UK-log-bis1-imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
ggsave(file="graphs/Adjusted-Wealth-Age-Profile-by-Gender-Median-UK-log-bis1-imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
ggsave(file="graphs/Adjusted-Wealth-Age-Profile-by-Gender-Mean-Britain-log-bis1-imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
saveRDS(dataukh, file = "data_rds/WAS-After-Step-v2-IO-8b-bis1-imp1.rds")
saveRDS(dataukh, file = "/Users/Juan/Google Drive/A-UK-Research/IO-Wealth-All-Countries/WAS-IOp/code/data_rds/WAS-After-Step-v2-IO-8b-bis1-imp1.rds")
