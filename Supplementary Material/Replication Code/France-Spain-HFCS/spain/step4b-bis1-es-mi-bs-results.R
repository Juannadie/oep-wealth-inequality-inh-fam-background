...
shapleyimps <- read.csv(file = "results/spain/bis1/es-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/spain/bis1/es-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/spain/bis1/es-results-interactive-full-imps.csv", row.names = NULL)
...
write.csv (spain_res_2, file = "results/spain/bis1/spain_res_2.csv")
