...
sesimps <- read.csv(file = "results/spain/es-results4types-full-imps.csv", row.names = NULL)
...
inhimps <- read.csv(file = "results/spain/es-results6types-full-imps.csv", row.names = NULL)
...
jointimps <- read.csv(file = "results/spain/es-results24types-full-imps.csv", row.names = NULL)
...
write.csv (spain_res, file = "results/spain/spain_res.csv")
