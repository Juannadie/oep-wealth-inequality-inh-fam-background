...
dataesh <- readRDS(file = "datasets/spain/v2-HFCS14_Spain_after_step_2c-no-pension-ad-eq_bis2_imp5.rds")
...
saveRDS(dataesh, file = "datasets/spain/v2-HFCS14_Spain_after_step_2d-no-pension-ad-eq_bis2_imp5.rds")
