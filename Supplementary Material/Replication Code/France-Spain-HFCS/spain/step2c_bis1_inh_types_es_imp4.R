...
dataesh <- readRDS(file = "datasets/spain/HFCS14_Spain_after_step_2b-no-pension-ad-eq_imp4.rds") ##
...
#We filter for negative wealth

dataesh <- dataesh[dataesh$wealth>0,]
dataesh <- dataesh[dataesh$age >= 50,]
...
saveRDS(dataesh, file = "datasets/spain/v2-HFCS14_Spain_after_step_2c-no-pension-ad-eq_bis1_imp4.rds")
