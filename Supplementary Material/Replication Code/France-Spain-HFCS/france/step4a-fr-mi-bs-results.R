...
sesimps <- read.csv(file = "results/france/fr-results4types-full-imps.csv", row.names = NULL)
...
inhimps <- read.csv(file = "results/france/fr-results6types-full-imps.csv", row.names = NULL)
...
jointimps <- read.csv(file = "results/france/fr-results24types-full-imps.csv", row.names = NULL)
...
write.csv (france_res, file = "results/france/france_res.csv")