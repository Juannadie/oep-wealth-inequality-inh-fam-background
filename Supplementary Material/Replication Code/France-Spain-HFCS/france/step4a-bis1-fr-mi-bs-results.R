...
sesimps <- read.csv(file = "results/france/bis1/fr-results4types-full-imps.csv", row.names = NULL)
...
inhimps <- read.csv(file = "results/france/bis1/fr-results6types-full-imps.csv", row.names = NULL)
...
jointimps <- read.csv(file = "results/france/bis1/fr-results24types-full-imps.csv", row.names = NULL)
...
france_res <- rbind (w_ineq_res, ses_ineq_res, ses_share_res, inh_ineq_res, inh_share_res, joint_ineq_res, joint_share_res)

colnames(france_res) <- c("estimate", "se", "low_ci", "high_ci")

write.csv (france_res, file = "results/france/bis1/france_res.csv")