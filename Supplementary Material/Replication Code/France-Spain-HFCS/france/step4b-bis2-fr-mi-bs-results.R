...
shapleyimps <- read.csv(file = "results/france/bis2/fr-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/france/bis2/fr-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/france/bis2/fr-results-interactive-full-imps.csv", row.names = NULL)
...
write.csv (france_res_2, file = "results/france/bis2/france_res_2.csv")
