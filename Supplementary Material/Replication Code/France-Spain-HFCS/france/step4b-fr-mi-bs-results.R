...
shapleyimps <- read.csv(file = "results/france/fr-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/france/fr-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/france/fr-results-interactive-full-imps.csv", row.names = NULL)
...
write.csv (france_res_2, file = "results/france/france_res_2.csv")
