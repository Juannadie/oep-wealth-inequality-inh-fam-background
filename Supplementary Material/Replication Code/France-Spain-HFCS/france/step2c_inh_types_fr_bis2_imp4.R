...
datafrh <- readRDS(file = "datasets/HFCS14_France_after_step_2b-no-pension-ad-eq_imp4.rds") ##
...
q10wealth <- wtd.quantile(datafrh$wealth, q=0.1, weight = datafrh$weight)
datafrh <- datafrh[datafrh$wealth > q10wealth,]
...
saveRDS(datafrh, file = "datasets/v2-HFCS14_France_after_step_2c-no-pension-ad-eq_bis2_imp4.rds")
