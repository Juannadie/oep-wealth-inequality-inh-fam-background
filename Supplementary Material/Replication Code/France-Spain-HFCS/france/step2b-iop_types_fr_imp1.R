...
datafr <- readRDS(file = "datasets/HFCS14_France_after_step_2a_imp1.rds") ##
...
table(datafrh$PNA0600a, datafrh$SA0100) #Only Italy has the education of the father / And Portugal
table(datafrh$PNA0600b, datafrh$SA0100) #Only Italy and Portugal have education of the mother
...
saveRDS(datafrh, file = "datasets/HFCS14_France_after_step_2b-no-pension-ad-eq_imp1.rds")
