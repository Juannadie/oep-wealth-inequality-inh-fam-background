...
datafrh <- readRDS(file = "datasets/v2-HFCS14_France_after_step_2c-no-pension-ad-eq_bis1_imp3.rds")
...
saveRDS(datafrh, file = "datasets/v2-HFCS14_France_after_step_2d-no-pension-ad-eq_bis1_imp3.rds")
