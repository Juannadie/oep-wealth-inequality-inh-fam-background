...
datafrh <- readRDS(file = "datasets/v2-HFCS14_France_after_step_2c-no-pension-ad-eq_bis2_imp1.rds")
...
ggsave(file="graphs/Wealth-Age-Profile-by-Gender-FR-no-pension-ad-eq-log-log-Oct19-bis2_imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
ggsave(file="graphs/Wealth-Age-Profile-by-Gender-Mean-FR-no-pension-ad-eq-log-Oct19-bis2_imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
ggsave(file="graphs/Adjusted-Wealth-Age-Profile-by-Gender-Median-FR-no-pension-ad-eq-log-Oct19-bis2_imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
ggsave(file="graphs/Adjusted-Wealth-Age-Profile-by-Gender-Mean-FR-no-pension-ad-eq-log-Oct19-bis2_imp1.pdf", device = "pdf", scale = 1, width = 7.5, height = 5, units = ("in"), dpi = 400, limitsize = TRUE)
...
saveRDS(datafrh, file = "datasets/v2-HFCS14_France_after_step_2d-no-pension-ad-eq_bis2_imp1.rds")
