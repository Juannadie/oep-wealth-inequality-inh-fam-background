...
datafrh <- readRDS(file = "datasets/HFCS14_France_after_step_2b-no-pension-ad-eq_imp2.rds") ##
...
saveRDS(datafrh, file = "datasets/v2-HFCS14_France_after_step_2c-no-pension-ad-eq_bis2_imp2.rds")
