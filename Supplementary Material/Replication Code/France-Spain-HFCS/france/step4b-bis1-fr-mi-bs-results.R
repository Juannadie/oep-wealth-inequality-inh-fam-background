...
shapleyimps <- read.csv(file = "results/france/bis1/fr-results-shapley-full-imps.csv", row.names = NULL)
...
marginalimps <- read.csv(file = "results/france/bis1/fr-results-marginal-full-imps.csv", row.names = NULL)
...
interactiveimps <- read.csv(file = "results/france/bis1/fr-results-interactive-full-imps.csv", row.names = NULL)
...
france_res_2 <- rbind (marginal_ses_res, marginal_inh_res, shapley_ses_res, shapley_inh_res, interactive_res)

colnames(france_res_2) <- c("estimate", "se", "low_ci", "high_ci")

write.csv (france_res_2, file = "results/france/bis1/france_res_2.csv")
