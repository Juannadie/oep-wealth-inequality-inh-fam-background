...
temp = list.files(pattern="v2-HFCS14_France_after_step_2d-no-pension-ad-eq_bis1_*") #creates a list with all the personal files in the eu-silc directory directory
...
write.csv(results4typesbsFRfull, file = "results/france/bis1/fr-results4types-full-imp1.csv")
write.table(results4typesbsFRfull, file = "results/france/bis1/fr-results4types-full-imps.csv", append = T, sep = ",", row.names = T)

results6typesbsFRfull <- rbind(indextheil6t, indextheil6tIE, indexshare6t)

write.csv(results6typesbsFRfull, file = "results/france/bis1/fr-results6types-full-imp1.csv")
write.table(results6typesbsFRfull, file = "results/france/bis1/fr-results6types-full-imps.csv", append = T, sep = ",", row.names = T)



results24typesbsFRfull <- rbind(indextheil24t, indextheil24tIE, indexshare24t)

write.csv(results24typesbsFRfull, file = "results/france/bis1/fr-results24types-full-imp1.csv")
write.table(results24typesbsFRfull, file = "results/france/bis1/fr-results24types-full-imps.csv", append = T, sep = ",", row.names = T)


resultsmarginalFR <- rbind(indexmarginal_bk, indexmarginal_inh )

write.csv(resultsmarginalFR, file = "results/france/bis1/fr-results-marginal-full-imp1.csv")
write.table(resultsmarginalFR, file = "results/france/bis1/fr-results-marginal-full-imps.csv", append = T, sep = ",", row.names = T)


resultsinteractiveFR <- indexinteractive_bk_inh

write.csv(resultsinteractiveFR, file = "results/france/bis1/fr-results-interactive-full-imp1.csv")
write.table(resultsinteractiveFR, file = "results/france/bis1/fr-results-interactive-full-imps.csv", append = T, sep = ",", row.names = T)


resultsshapleyFR <- rbind(indexshapley_bk, indexshapley_inh )

write.csv(resultsshapleyFR, file = "results/france/bis1/fr-results-shapley-full-imp1.csv")
write.table(resultsshapleyFR, file = "results/france/bis1/fr-results-shapley-full-imps.csv", append = T, sep = ",", row.names = T)
